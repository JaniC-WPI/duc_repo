...
cp ~/duc_repo/src/panda_test/config/franka_dl_multi_config.yaml  ~/Pictures/Dl_Exps/dl_vs/servoing/exps/$exp_no/
cp ~/duc_repo/src/panda_test/config/dl_multi_features.yaml  ~/Pictures/Dl_Exps/dl_vs/servoing/exps/$exp_no/
