...
#         self.e6 = encoder_block(128, 256)
#         self.e7 = encoder_block(256, 512)
...
#         self.e4 = encoder_block(32, 64, dropout_rate=0.1)
#         self.e5 = encoder_block(64, 128, dropout_rate=0.1)
#         self.e6 = encoder_block(128, 256, dropout_rate=0.2)
#         self.e7 = encoder_block(256, 512, dropout_rate=0.2)
#         self.b = conv_block(512, 1024)
#         self.d1 = decoder_block(1024, 512)
#         self.d2 = decoder_block(512, 256)
#         self.d3 = decoder_block(256, 128)
