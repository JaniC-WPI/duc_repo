...
root_dir = parent_path + "path_planning_panda_train/"
...
def train_test_split(src_dir):
    ...
    output = parent_path + "split_folder_output_plan" + "-" + path.year + "-" + path.month + "-" + path.day
...
split_folder = train_test_split(root_dir)

KEYPOINTS_FOLDER_TRAIN = split_folder +"/train" #train_test_split(root_dir) +"/train"
KEYPOINTS_FOLDER_VAL = split_folder +"/val"
KEYPOINTS_FOLDER_TEST = split_folder +"/test"
...
for b_size in batch_sizes:
    for epochs in epochs_lst:
        ...
        PATH = f"/home/schatterjee/lama/kprcnn_panda/trained_models/keypointsrcnn_planning_b{b_size}_e{epochs}_v{v}.pth"
