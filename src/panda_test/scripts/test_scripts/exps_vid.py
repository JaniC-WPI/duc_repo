...
# Parameters
image_folder = '/home/jc-merlab/Pictures/Dl_Exps/dl_vs/servoing/exps/1_with_obs_2/'  # Replace with your folder path
video_name = '/home/jc-merlab/Pictures/Dl_Exps/dl_vs/servoing/exps/1_with_obs_2/output_video.avi'
frame_rate = 60  # frames per second
overlay_image_path = '/home/jc-merlab/Pictures/Dl_Exps/dl_vs/servoing/exps/1_with_obs_2/dl_published_goal_image.jpg'  # Path to overlay image
...
# Generate image list
images = [f"{i}.png" for i in range(6038)]  # Adjust the range if needed
