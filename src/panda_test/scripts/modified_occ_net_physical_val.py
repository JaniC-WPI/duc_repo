...
# Load the checkpoint
checkpoint_path = '/home/jc-merlab/Pictures/Data/trained_models/occ_ckpt_fifty_k/kprcnn_occ_net_ckpt_fifty_k_b64e56.pth'
checkpoint = torch.load(checkpoint_path)
...
#         dist = np.linalg.norm(np.array(pred_kp) - np.array(gt_kp))
#         if dist <= margin:
#             correct += 1
...
output_path = '/home/jc-merlab/Pictures/Data/occ_phys_test_data/occ_output_fifty_k2/'
...
#             # Calculate and store accuracy
#             accuracy = calculate_accuracy(denormalized_keypoints, ground_truth_keypoints, margin=10)
#             accuracies.append(accuracy)
#             print(f"Accuracy for {filename}: {accuracy}%")
...
# folder_path = '/home/jc-merlab/Pictures/Data/occ_phys_test_data/'
# output_path = '/home/jc-merlab/Pictures/Data/occ_phys_test_data/output_fifty_k/'
# output_path_line = '/home/jc-merlab/Pictures/Data/occ_test_op_line/'
# process_folder(folder_path, output_path, output_path_line)