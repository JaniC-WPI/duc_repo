...
def train_test_split(src_dir):
    ...
    splitfolders.ratio(src_dir, # The location of dataset
                   ...
                   ratio=(.95, 0.25, 0.25), # The ratio of split dataset
...
class KeypointPipeline(nn.Module):
    def __init__(self, weights_path):
        ...
        self.encoder = GraphEncoder(3,512,2,0.5,False)
...
#                                     cfg.MODEL.ROI_GRAPH_HEAD.ENCODER_FACTOR)
    ...
    def keypoints_to_graph(self, keypoints, image_width, image_height):
        ...
        print("graph features shape 1", graph_features.shape)
        ...
        print("graph features shape 2", graph_features.shape)
...
model_save_path = f"/home/schatterjee/lama/kprcnn/trained_models/krcnn_occ_b{batch_size}_e{num_epochs}_v{v}.pth"
