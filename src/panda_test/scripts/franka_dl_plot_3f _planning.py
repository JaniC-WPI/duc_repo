...
def main(args):
    ...
    with open('/home/jc-merlab/Pictures/Dl_Exps/dl_vs/servoing/exps/cust_3/3/err.csv','r') as csvfile:
    ...
    plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/dl_vs/servoing/exps/cust_3/3/feature_error.png', dpi=300)
