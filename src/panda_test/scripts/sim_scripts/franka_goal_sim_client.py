...
def main():
    # initialize the node
    rospy.init_node('franka_sim_goal_vis_node') 
    ...
    franka_kp_dl_service = rospy.ServiceProxy('franka_kp_dl_service', dl_sim_img)    
    ...
    cv2.imwrite("sim_published_goal_image.jpg", cv_img)    
