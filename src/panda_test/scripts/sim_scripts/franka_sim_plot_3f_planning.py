...
def main(args):
    ...
    err_data = []
    # read feature error
    with open('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/17/err.csv', 'r') as csvfile:
    ...
    plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/17/error_norm.png', dpi=300)
    plt.close()
    ...
    plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/17/feature_errors.png', dpi=300)
    plt.close()

    mod_err_data = []
    # read feature error
    with open('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/17/individual_model_errors.csv', 'r') as csvfile:
    ...
    plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/17/ind_mod_error.png', dpi=300)
    plt.close()
    ...
    with open('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/17/modelerror.csv', 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=',')
        for row in plots:
            model_error.append(row)

    # # Read joint velocities
    with open('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/17/j1vel.csv', 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=',')
        for row in plots:
            j1_vel.append(row)

    with open('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/17/j2vel.csv', 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=',')
        for row in plots:
            j2_vel.append(row)

    with open('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/17/j3vel.csv', 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=',')
        for row in plots:
            j3_vel.append(row)
    ...
    plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/17/model_error.png', dpi=300)
    plt.close()
    ...
    # plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/17/plot.png', dpi=400)
    # plt.close()
    ...
    # plt.tight_layout()
    plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/17/j1_velocity.png', dpi=300)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/17/j2_velocity.png', dpi=300)
    plt.close()
    ...
    # plt.tight_layout()
    plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/17/j3_velocity.png', dpi=300)
    plt.close()
