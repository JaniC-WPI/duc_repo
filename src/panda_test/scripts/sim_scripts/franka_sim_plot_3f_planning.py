...
def main(args):
    ...
    err_data = []
    # read feature error
    with open('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/25/err.csv', 'r') as csvfile:
    ...
    iteration_ticks = np.arange(0, len(err_norm), 450)
    ...
    plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/25/error_norm.png', dpi=300)
    plt.close()
    ...
    ax2.grid()
    yticks = np.arange(np.min(err_data) - 10, np.max(err_data) + 20, 20)
    ...
    plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/25/feature_errors.png', dpi=300)
    plt.close()

    mod_err_data = []
    # read feature error
    with open('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/25/individual_model_errors.csv', 'r') as csvfile:
    ...
    plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/25/ind_mod_error.png', dpi=300)
    plt.close()
    ...
    with open('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/25/modelerror.csv', 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=',')
        for row in plots:
            model_error.append(row)

    # # Read joint velocities
    with open('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/25/j1vel.csv', 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=',')
        for row in plots:
            j1_vel.append(row)

    with open('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/25/j2vel.csv', 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=',')
        for row in plots:
            j2_vel.append(row)

    with open('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/25/j3vel.csv', 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=',')
        for row in plots:
            j3_vel.append(row)
    ...
    # ax1.set_yticks(np.arange(0, max(model_error)))
    ax1.tick_params(axis='y', labelsize=6)  # Reduce y-axis tick size
    ...
    plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/25/model_error.png', dpi=300)
    plt.close()
    ...
    # plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/25/plot.png', dpi=400)
    # plt.close()
    ...
    # plt.tight_layout()
    plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/25/j1_velocity.png', dpi=300)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/25/j2_velocity.png', dpi=300)
    plt.close()
    ...
    # plt.tight_layout()
    plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/sim_vs/servoing/exps/25/j3_velocity.png', dpi=300)
    plt.close()
