...
if __name__ == "__main__":
    ...
    image_path = '/home/jc-merlab/Pictures/panda_data/panda_sim_vel/rrt_test_image/red_ball_image_3.jpg'  # Replace with the path to your image file
    ...
    # Build the roadmap
    roadmap = build_roadmap(configurations, num_neighbors, obstacle_center, SAFE_DISTANCE)
