...
int main(int argc, char **argv){
    ...
    while(ros::ok()){
        ...
        // Comment - This block is to activate 3 joints in planar for physical
        franka_joint_vel.data.push_back(0);
        franka_joint_vel.data.push_back(j1_vel);    // joint 2 on Franka
        franka_joint_vel.data.push_back(0);     
        franka_joint_vel.data.push_back(j2_vel);    // joint 4 on Franka
        franka_joint_vel.data.push_back(0);
        franka_joint_vel.data.push_back(j3_vel);    // joint 6 on Franka
        franka_joint_vel.data.push_back(0);


        // Comment - This block is to activate 3D motion for physical
