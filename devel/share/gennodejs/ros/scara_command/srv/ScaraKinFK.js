...
class ScaraKinFKRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ScaraKinFKRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ScaraKinFKRequest
    let len;
    let data = new ScaraKinFKRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ScaraKinFKRequest(null);
    if (msg.q1 !== undefined) {
      resolved.q1 = msg.q1;
    }
    else {
...
class ScaraKinFKResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ScaraKinFKResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ScaraKinFKResponse
    let len;
    let data = new ScaraKinFKResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ScaraKinFKResponse(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
module.exports = {
  Request: ScaraKinFKRequest,
  Response: ScaraKinFKResponse,
  md5sum() { return '7861a4dbb7e9452dabc20f2eff991915'; },
  datatype() { return 'scara_command/ScaraKinFK'; }
};
