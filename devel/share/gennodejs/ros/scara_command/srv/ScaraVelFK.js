...
class ScaraVelFKRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ScaraVelFKRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ScaraVelFKRequest
    let len;
    let data = new ScaraVelFKRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ScaraVelFKRequest(null);
    if (msg.q1 !== undefined) {
      resolved.q1 = msg.q1;
    }
    else {
...
class ScaraVelFKResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ScaraVelFKResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ScaraVelFKResponse
    let len;
    let data = new ScaraVelFKResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ScaraVelFKResponse(null);
    if (msg.Vx !== undefined) {
      resolved.Vx = msg.Vx;
    }
    else {
...
module.exports = {
  Request: ScaraVelFKRequest,
  Response: ScaraVelFKResponse,
  md5sum() { return 'd154cd82f0b9fb9f1cf33ba88636c898'; },
  datatype() { return 'scara_command/ScaraVelFK'; }
};
